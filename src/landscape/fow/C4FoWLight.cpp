...
void C4FoWLight::CalculateFanMaxed(TriangleList &Triangles)
{
...
void C4FoWLight::DrawFan(C4FoWDrawStrategy* pen, TriangleList &triangles)
{
	pen->BeginFan();
...
void C4FoWLight::DrawFanMaxed(C4FoWDrawStrategy* pen, TriangleList &triangles)
{
	pen->BeginFanMaxed();
	for (TriangleList::iterator it = triangles.begin(), nextIt = it; it != triangles.end(); ++it)
	{
...
void C4FoWLight::DrawFade(C4FoWDrawStrategy* pen, TriangleList &triangles)
{
	pen->BeginFade();
...
void C4FoWLight::DrawIntermediateFadeTriangles(C4FoWDrawStrategy* pen, TriangleList &triangles)
{
