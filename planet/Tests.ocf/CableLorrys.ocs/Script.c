 ...
 func JoinPlayer(int iPlr)
{
	...
	CreateObject(CableLine, 104, 486)->SetConnectedObjects(obj1, obj2);
	CreateObject(CableLine, 191, 438)->SetConnectedObjects(obj2, obj3);
	CreateObject(CableLine, 191, 438)->SetConnectedObjects(obj3, obj4);
	CreateObject(CableLine, 191, 438)->SetConnectedObjects(obj4, obj5);
	CreateObject(CableLine, 191, 438)->SetConnectedObjects(obj3, obj6);
	CreateObject(CableLine, 191, 438)->SetConnectedObjects(obj5, obj7);
//	CreateObject(CableLine, 191, 438)->SetConnectedObjects(obj6, obj7);
//	CreateObject(CableLine, 191, 438)->SetConnectedObjects(obj6, obj9);
//	CreateObject(CableLine, 191, 438)->SetConnectedObjects(obj4, obj8);
//	WaypointsMakeList();
